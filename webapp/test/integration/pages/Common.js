sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Git/Test/ZGitTest1/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("Git.Test.ZGitTest1.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Git/Test/ZGitTest1/localService/mockserver"], function (mockserver) {
